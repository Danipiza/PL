...
/** CUP v0.11b beta 20140220 generated parser.
  * @version Sun Apr 07 18:04:31 CEST 2024
  */
      ...
      switch (CUP$ConstructorASTEval$act_num)
        {
          ...
          case 0: // programa ::= expresion declaraciones 
            {
              Prog RESULT =null;
		Location expxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.elementAt(CUP$ConstructorASTEval$top-1)).xleft;
		Location expxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.elementAt(CUP$ConstructorASTEval$top-1)).xright;
		Exp exp = (Exp)((java_cup.runtime.Symbol) CUP$ConstructorASTEval$stack.elementAt(CUP$ConstructorASTEval$top-1)).value;
		Location decsxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.peek()).xleft;
		Location decsxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.peek()).xright;
		Decs decs = (Decs)((java_cup.runtime.Symbol) CUP$ConstructorASTEval$stack.peek()).value;
		 RESULT = sem.prog(exp,decs); 
          ...
          case 1: // $START ::= programa EOF 
            {
              Object RESULT =null;
		Location start_valxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.elementAt(CUP$ConstructorASTEval$top-1)).xleft;
		Location start_valxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.elementAt(CUP$ConstructorASTEval$top-1)).xright;
		...
		RESULT = start_val;
          ...
          case 2: // expresion ::= EVALUA E0 
            {
              Exp RESULT =null;
		Location expxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.peek()).xleft;
		Location expxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.peek()).xright;
          ...
          case 4: // declaraciones ::= 
            {
              Decs RESULT =null;
		 RESULT = sem.no_decs(); 
              CUP$ConstructorASTEval$result = parser.getSymbolFactory().newSymbol("declaraciones",5, ((java_cup.runtime.Symbol)CUP$ConstructorASTEval$stack.peek()), ((java_cup.runtime.Symbol)CUP$ConstructorASTEval$stack.peek()), RESULT);
            }
          return CUP$ConstructorASTEval$result;
          ...
          case 5: // lista_declaraciones ::= lista_declaraciones COMA declaracion 
            {
              LDecs RESULT =null;
		Location decsxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.elementAt(CUP$ConstructorASTEval$top-2)).xleft;
		Location decsxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.elementAt(CUP$ConstructorASTEval$top-2)).xright;
		LDecs decs = (LDecs)((java_cup.runtime.Symbol) CUP$ConstructorASTEval$stack.elementAt(CUP$ConstructorASTEval$top-2)).value;
		Location decxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.peek()).xleft;
		Location decxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.peek()).xright;
		...
		Dec dec = (Dec)((java_cup.runtime.Symbol) CUP$ConstructorASTEval$stack.peek()).value;
		 RESULT = sem.una_dec(dec);
          ...
          case 7: // declaracion ::= IDEN IGUAL E0 
            {
              Dec RESULT =null;
		Location idxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.elementAt(CUP$ConstructorASTEval$top-2)).xleft;
		Location idxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.elementAt(CUP$ConstructorASTEval$top-2)).xright;
		...
		Exp exp = (Exp)((java_cup.runtime.Symbol) CUP$ConstructorASTEval$stack.peek()).value;
		 RESULT = (Dec)sem.dec(id.str(),exp).ponFila(id.fila()).ponCol(id.col()); 
          ...
          case 8: // E0 ::= E0 OP0 E1 
            {
              Exp RESULT =null;
		Location opnd1xleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.elementAt(CUP$ConstructorASTEval$top-2)).xleft;
		Location opnd1xright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.elementAt(CUP$ConstructorASTEval$top-2)).xright;
		Exp opnd1 = (Exp)((java_cup.runtime.Symbol) CUP$ConstructorASTEval$stack.elementAt(CUP$ConstructorASTEval$top-2)).value;
		Location opxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.elementAt(CUP$ConstructorASTEval$top-1)).xleft;
		Location opxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.elementAt(CUP$ConstructorASTEval$top-1)).xright;
		String op = (String)((java_cup.runtime.Symbol) CUP$ConstructorASTEval$stack.elementAt(CUP$ConstructorASTEval$top-1)).value;
		Location opnd2xleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.peek()).xleft;
		Location opnd2xright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.peek()).xright;
		...
		Exp exp = (Exp)((java_cup.runtime.Symbol) CUP$ConstructorASTEval$stack.peek()).value;
		 RESULT = exp; 
          ...
          case 12: // E2 ::= IDEN 
            {
              Exp RESULT =null;
		Location idxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.peek()).xleft;
		Location idxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.peek()).xright;
		StringLocalizado id = (StringLocalizado)((java_cup.runtime.Symbol) CUP$ConstructorASTEval$stack.peek()).value;
		 RESULT = (Exp)sem.iden(id.str()).ponFila(id.fila()).ponCol(id.col()); 
          ...
          case 13: // E2 ::= ENT 
            {
              Exp RESULT =null;
		Location numxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.peek()).xleft;
		Location numxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ConstructorASTEval$stack.peek()).xright;
