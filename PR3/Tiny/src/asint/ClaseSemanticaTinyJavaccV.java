...
import asint.SintaxisAbstractaTinyJavaccR.Exp;

public class ClaseSemanticaTinyJavaccV extends SintaxisAbstractaTinyJavaccV {
    public ClaseSemanticaTinyJavaccV() {
        super();
    }
